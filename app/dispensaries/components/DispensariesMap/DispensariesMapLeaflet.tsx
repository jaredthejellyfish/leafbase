...
const DispensariesMapLeaflet = () => {
  ...
  return (
    <div className="relative z-0 flex flex-col w-[99vw] lg:w-[70vw] p-3 m-1 shadow-md border border-zinc-100 dark:border-zinc-900 h-screen-bar rounded-xl dark:bg-zinc-900">
