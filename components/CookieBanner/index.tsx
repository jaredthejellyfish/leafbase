...
function CookieBanner() {
  ...
  return (
    <div
      ...
      id="cookie-consent"
    >
      <div className="z-50 inline-block overflow-hidden rounded-lg border-transparent bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle dark:bg-zinc-800">
        <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 dark:bg-transparent">
        ...
        <div className="bg-zinc-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 dark:bg-zinc-700/20">
          <button
