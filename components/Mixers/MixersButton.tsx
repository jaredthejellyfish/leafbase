...
const MixersButton = (props: Props) => {
  ...
  return (
    <div className="relative">
      <button
        className="px-2 py-1 text-sm transition border rounded-lg w-30 text-zinc-300 hover:text-white hover:dark:bg-zinc-500 border-zinc-300"
      ...
      <AnimatePresence>
        {isModalOpen && (
          ...
          >
            <div className="relative flex flex-col w-full px-8 py-4 mx-3 bg-white sm:px-10 h-4/7 md:h-4/7 xl:w-1/2 md:w-2/3 rounded-xl dark:bg-zinc-900">
              <div className="flex flex-row items-center justify-between mb-4 text-xl font-bold">
                <h1 className="">Recommended Strains</h1>
                <button
                  onClick={() => setIsModalOpen(!isModalOpen)}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center w-2/3 py-2 ml-5">
                            <p className="px-1 mt-1 font-medium">
                              {recommendation.name}
                            </p>
                            ...
                            <div className="flex flex-row items-center gap-2">
                              <p className="px-1 mt-1 text-sm font-medium text-gray-500">
